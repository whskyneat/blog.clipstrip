...
function x_shortcode_content_band( $atts, $content = null ) {
  ...
  if ( $bg_video != '' ) {
    ...
    $output = "<div id=\"x-content-band-{$count}\" class=\"{$class}{$bg_video_class}{$border}{$no_margin}\" style=\"{$padding_top}{$padding_bottom}{$style}\">"
            ...
            . '</div>'
            . "<script> jQuery(function(){ var BV = new jQuery.BigVideo(); BV.init(); if ( Modernizr.touch ) { BV.show('{$bg_video_poster}'); } else { BV.show('{$bg_video}', { ambient : true }); } }); </script>";
...
// (This shortcode was deprecated in 2.5.1)
//
