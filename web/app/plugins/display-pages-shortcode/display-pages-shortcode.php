...
function string_limit_display_page_shortcode($string, $word_limit)
{
...
function be_display_pages_shortcode( $atts ) {
	...
	if ( $i == $column_count )
		...
		if ( $read_more )	
			...
			$read_more_link = '<br /><a class="read_more" href="' . get_permalink() . '"><span class="read_more">Read More</span></a>';
