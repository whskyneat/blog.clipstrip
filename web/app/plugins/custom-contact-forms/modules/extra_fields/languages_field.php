...
*/
if (!class_exists('ccf_languages_field')) {
	class ccf_languages_field {
		var $field_code;
		
		function ccf_languages_field($class = NULL, $id = NULL, $initial_value = NULL, $field_instructions = NULL) {
			$this->field_code = '';
