...
jQuery(function($){
    ...
    $.each(customizeSettings, function(id, el){
        ...
        if(typeof el.selector == 'string') el.selector = [el.selector];
        else if(typeof el.selector == 'undefined') el.selector = [];
                ...
                case 'color' :
                    wp.customize( id, function( value ) {
                        value.bind( function( newval ) {
                            if(typeof el.property == 'string') el.property = [el.property];
